...
#define APP_INFO_PRODUCTVERSION         0,0,1,0
#define APP_INFO_PRODUCTVERSION_STR     "0.0.1"

#define APP_INFO_FILEVERSION            APP_INFO_PRODUCTVERSION
#define APP_INFO_FILEVERSION_STR        APP_INFO_PRODUCTVERSION_STR

#define APP_INFO_PRODUCTNAME_STR        "ClipboardTool"
...
#define APP_INFO_LEGALCOPYRIGHT_STR     "Copyright © 2021 " APP_INFO_COMPANYNAME_STR
...
#define APP_INFO_ORIGINALFILENAME_STR   "ClipboardTool.exe"
